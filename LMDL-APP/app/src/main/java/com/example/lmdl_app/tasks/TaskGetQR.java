 ...
 */
public class TaskGetQR extends AsyncTask<String,Void, String>
{
    private String tag = "TaskGetQR";
    private VerQR activity;
    private String urlStr = "";

    public TaskGetQR(VerQR activity)
    {
    ...
    protected void onPostExecute(String response)
    {
        ...
        try
        {
            ...
            if(urlStr.contains("GetCodQR"))
            {
                activity.setCodUsuario(response);
            }
